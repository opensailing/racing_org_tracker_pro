defmodule RacingOrg.Tracker.CAN.CANUSB.Server do
  @moduledoc """
  ...
  alias RacingOrg.Tracker.CAN.CANUSB.Protocol
  ...
  def init({driver_config, parent_pid}) do
    ...
    :ok =
      Circuits.UART.open(uart_pid, port,
        ...
        speed: 115_200,
        active: true,
        framing: {RacingOrg.Tracker.CAN.CANUSB.Framing, separator: Protocol.separator()}
      )
