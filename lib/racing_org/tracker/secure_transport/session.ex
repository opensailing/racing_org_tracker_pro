defmodule RacingOrg.Tracker.SecureTransport.Session do
  @moduledoc """
  ...
  Created by `RacingOrg.Tracker.SecureTransport.Handshake`; consumed by
  `RacingOrg.Tracker.SecureTransport.Frame`.
  ...
  alias RacingOrg.Tracker.SecureTransport.ReplayWindow
