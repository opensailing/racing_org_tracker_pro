defmodule RacingOrg.Tracker.Compute.Store do
  @moduledoc """
  ...
  Mirrors `RacingOrg.Tracker.Tracking.Store`: the config is written to a temp file and
  ...
  The persisted config is the normalized map produced by `RacingOrg.Tracker.Compute.Engine`:
