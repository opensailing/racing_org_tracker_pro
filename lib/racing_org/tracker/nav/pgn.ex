defmodule RacingOrg.Tracker.Nav.PGN do
  @moduledoc """
  Encodes outbound NMEA 2000 navigation *display* PGNs from a `RacingOrg.Tracker.Nav.State`:
  ...
  best-effort encoding. Prefer the GPX export (`RacingOrg.Tracker.Nav.GPX`) when route
