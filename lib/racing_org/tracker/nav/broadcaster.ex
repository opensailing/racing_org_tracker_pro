defmodule RacingOrg.Tracker.Nav.Broadcaster do
  @moduledoc """
  ...
  It derives the nav state from the active assignment (`RacingOrg.Tracker.Commands`) and
  ...
  def init(opts) do
    ...
    state = %{
      ...
      compute: normalize_compute(Keyword.get(opts, :compute, RacingOrg.Tracker.Compute.Engine)),
      interval: interval,
