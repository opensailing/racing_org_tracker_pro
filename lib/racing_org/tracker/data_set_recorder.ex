defmodule RacingOrg.Tracker.DataSetRecorder do
  @moduledoc """
  ...
  See also: RacingOrg.Tracker.DataSetUploader
  """
  use GenServer

  require Logger

  alias RacingOrg.Tracker.DataSetUploader
  ...
  defp save_data_points(data_points, state) do
    data_set = RacingOrg.Tracker.data_set(data_points)
    ...
    RacingOrg.Tracker.Race.Archive.record(encoded)
    DataSetUploader.add_file(path)
  end
  ...
  defp save_network_devices(network_devices, state) do
    data_set = RacingOrg.Tracker.data_set([], network_devices: network_devices)
