defmodule RacingOrg.Tracker.CAN do
  @moduledoc """
  ...
  def child_spec(config) do
    %{
      id: __MODULE__,
      start: {RacingOrg.Tracker.CAN.Server, :start_link, [config]}
    }
  end

  defdelegate transmit_frame(frame), to: RacingOrg.Tracker.CAN.Server
