defmodule RacingOrg.Tracker.WebClients.UDPClient.Server do
  @moduledoc """
  ...
  same socket, forwarding them to `RacingOrg.Tracker.Commands`.
  """
  ...
  def init(opts) do
    ...
    commands = opts[:commands] || RacingOrg.Tracker.Commands
