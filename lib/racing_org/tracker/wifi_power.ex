defmodule RacingOrg.Tracker.WiFiPower do
  @moduledoc """
  ...
  `RacingOrg.Tracker.Application`) — then cuts the residual radio power:
  ...
  down. Same effect as `disable/1`, named for the `RacingOrg.Tracker.WiFiManager`
