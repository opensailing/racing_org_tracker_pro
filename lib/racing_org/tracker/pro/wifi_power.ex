defmodule RacingOrg.Tracker.Pro.WiFiPower do
  @moduledoc """
  ...
  `RacingOrg.Tracker.Pro.Application`) — then cuts the residual radio power:
  ...
  down. Same effect as `disable/1`, named for the `RacingOrg.Tracker.Pro.WiFiManager`
