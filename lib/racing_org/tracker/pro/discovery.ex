defmodule RacingOrg.Tracker.Pro.Discovery do
  @moduledoc """
  ...
  def handle_info(:update_devices, state) do
    ...
    |> to_network_devices()
    |> RacingOrg.Tracker.Pro.DataSetRecorder.add_network_devices()
  ...
  def to_network_devices(known_network_devices) do
    Enum.map(known_network_devices, fn {_source_addr, %DeviceInfo{} = device_info} ->
      struct(NetworkDevice,
        hw_id: RacingOrg.Tracker.Pro.DeviceInfo.hw_id(device_info.nmea_name),
