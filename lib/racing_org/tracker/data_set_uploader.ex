defmodule RacingOrg.Tracker.DataSetUploader do
  @moduledoc """
  ...
  See also: RacingOrg.Tracker.DataSetRecorder
  """
  use GenServer
  ...
  alias RacingOrg.Tracker.WebClients.HTTPClient
