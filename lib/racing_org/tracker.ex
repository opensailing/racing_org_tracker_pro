defmodule RacingOrg.Tracker do
  @moduledoc """
  Documentation for RacingOrg.Tracker.
  """
  ...
  def data_set(data_points, opts \\ []) do
    base = [
      ...
      ack: RacingOrg.Tracker.Commands.current_ack(),
  ...
  defp current_sample_mode do
    RacingOrg.Tracker.Sampling.Mode.to_proto(RacingOrg.Tracker.Sampling.current_mode())
  catch
    :exit, _ -> :SAMPLE_MODE_UNSPECIFIED
  end

  defp current_race_phase do
    RacingOrg.Tracker.Sampling.Phase.to_proto(RacingOrg.Tracker.Sampling.current_phase())
  catch
