defmodule NauticNet.Compute.PgnEncode do
  @moduledoc """
  ...
  (`NauticNet.NMEA2000.J1939.*Params` in the `nautic_net_nmea2000` dep), so a payload
  ...
  `NauticNet.Compute.Engine` — at minimum `output_pgn`, `output_field`,
