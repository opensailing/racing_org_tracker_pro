defmodule NauticNet.Compute.Store do
  @moduledoc """
  ...
  Mirrors `NauticNet.Tracking.Store`: the config is written to a temp file and
  ...
  The persisted config is the normalized map produced by `NauticNet.Compute.Engine`:
