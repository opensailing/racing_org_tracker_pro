defmodule NauticNet.SecureTransport.Session do
  @moduledoc """
  ...
  Created by `NauticNet.SecureTransport.Handshake`; consumed by
  `NauticNet.SecureTransport.Frame`.
  ...
  alias NauticNet.SecureTransport.ReplayWindow
