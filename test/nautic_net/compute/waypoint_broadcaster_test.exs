defmodule NauticNet.Compute.WaypointBroadcasterTest do
  use ExUnit.Case, async: true

  alias NauticNet.Commands.Assignment
  alias NauticNet.Compute.WaypointBroadcaster
  ...
  # route/waypoint commands), mirroring the real command flow + NauticNet.Nav.State.
