defmodule NauticNet.Commands.PersistenceTest do
  use ExUnit.Case, async: true

  alias NauticNet.Commands
  alias NauticNet.Protobuf.ActiveWaypointUpdate
  alias NauticNet.Protobuf.CancelAssignment
  alias NauticNet.Protobuf.DeviceCommand
  alias NauticNet.Protobuf.LatLon
  alias NauticNet.Protobuf.NoopCommand
  alias NauticNet.Protobuf.RaceAssignment
  alias NauticNet.Protobuf.RouteUpdate
  ...
  test "an applied assignment survives a restart, and stale commands are rejected after reboot", %{dir: dir} do
    ...
    :ok = stop_supervised(NauticNet.Commands)
    ...
    # ACK is restored so SailRoute learns the device already applied this command.
