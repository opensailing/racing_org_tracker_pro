defmodule NauticNet.Race.ArchiveTest do
  ...
  test "deletes the recording once SailRoute confirms it complete", %{base: base} do
    %{commands: c, archive: a} = start_archive(base)
