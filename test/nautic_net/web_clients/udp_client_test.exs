defmodule NauticNet.WebClients.UDPClientTest do
  @moduledoc """
  ...
  alias NauticNet.SecureTransport.{Frame, Session, SessionHolder}
  alias NauticNet.WebClients.UDPClient

  @magic NauticNet.SecureTransport.magic()
  @version NauticNet.SecureTransport.protocol_version()
  @type_data NauticNet.SecureTransport.type_data()
  @aead_id NauticNet.SecureTransport.aead_chacha20_poly1305()
  @header_size NauticNet.SecureTransport.header_size()
