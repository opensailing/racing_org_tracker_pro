defmodule RacingOrg.Tracker.CANTest do
  use ExUnit.Case
  ...
  setup do
    ...
    start_supervised!(
      {RacingOrg.Tracker.CAN,
       driver: RacingOrg.Tracker.CAN.Fake.Driver,
       handlers: [
         {RacingOrg.Tracker.PacketHandler.Callbacks,
  ...
  defp replay_until_completion(log, timeout \\ 5000) do
    :ok = RacingOrg.Tracker.CAN.Fake.Driver.replay_canusb_log(log)
