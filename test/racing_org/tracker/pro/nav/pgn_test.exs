defmodule RacingOrg.Tracker.Pro.Nav.PGNTest do
  ...
  test "129284 Navigation Data encodes destination, waypoints, and distance" do
    ...
    <<_sid::8, distance::little-32, _flags::8, _eta_time::little-32, _eta_date::little-16, _brg_od::little-16,
      _brg_pd::little-16, origin_wp::little-32, dest_wp::little-32, dest_lat::little-signed-32,
      dest_lon::little-signed-32, _closing::little-signed-16>> = payload
