defmodule RacingOrg.Tracker.Pro.DataSetAckTest do
  # Not async: exercises the application's named RacingOrg.Tracker.Pro.Commands process.
  use ExUnit.Case
