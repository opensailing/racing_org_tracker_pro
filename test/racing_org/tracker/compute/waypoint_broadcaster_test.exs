defmodule RacingOrg.Tracker.Compute.WaypointBroadcasterTest do
  use ExUnit.Case, async: true

  alias RacingOrg.Tracker.Commands.Assignment
  alias RacingOrg.Tracker.Compute.WaypointBroadcaster
  ...
  # route/waypoint commands), mirroring the real command flow + RacingOrg.Tracker.Nav.State.
