defmodule RacingOrg.Tracker.SecureTransport.ChannelClientTest do
  @moduledoc """
  ...
  describe "set_wifi / wifi_status (SocketTest)" do
    # A fake WiFi collaborator (mirrors the RacingOrg.Tracker.WiFiManager API surface J5
  ...
  describe "set_tracking / tracking_status (SocketTest)" do
    # A fake Tracking collaborator mirroring the RacingOrg.Tracker.Tracking.Config API
