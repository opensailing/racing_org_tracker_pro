defmodule RacingOrg.Tracker.SecureTransport.BootProvisionerTest do
  @moduledoc """
  ...
  alias RacingOrg.Tracker.SecureTransport.BootProvisioner
  ...
  setup do
    ...
    srv_pub = RacingOrg.Tracker.SecureTransport.Primitives.ed25519_public_from_secret(:binary.copy(<<0xB2>>, 32))
