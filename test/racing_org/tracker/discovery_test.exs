defmodule RacingOrg.Tracker.DiscoveryTest do
  use ExUnit.Case

  alias RacingOrg.Tracker.Discovery
  ...
  # NetworkMonitor. RacingOrg.Tracker.Discovery polls the virtual device and maps its
